(function (global, factory) {
    ...
    var computeXYScalesForSeries = function computeXYScalesForSeries(_series, xScaleSpec, yScaleSpec, width, height) {
      ...
      var xScale = computeScale(_objectSpread(_objectSpread({}, xScaleSpec), {}, {
        axis: 'x'
      }), xy, width, height);
      var yScale = computeScale(_objectSpread(_objectSpread({}, yScaleSpec), {}, {
        axis: 'y'
      }), xy, width, height);
      ...
      return _objectSpread(_objectSpread({}, xy), {}, {
        series: series,
        xScale: xScale,
        yScale: yScale
      });
    ...
    var computeAxisSlices = function computeAxisSlices(axis, data) {
      ...
      return data[otherAxis].all.map(function (v) {
        ...
        data.series.forEach(function (serie) {
          ...
          if (datum !== undefined) {
            slice.data.push(_objectSpread(_objectSpread({}, datum), {}, {
              serie: serie
            }));
          }
        });
